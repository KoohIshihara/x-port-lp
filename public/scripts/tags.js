...
riot.tag2('module-works', '<div class="wrap-module"> <item-h2 class="mb32" content="{h2}"></item-h2> <div class="wrap-works f flex-wrap flex-row flex-between"> <item-work each="{item in works}" content="{item}"></item-work> <div class="box-dummy"> <div class="dummy-content"></div> </div> </div> </div>', 'module-works,[data-is="module-works"]{display:block;background:#fff} module-works .wrap-module,[data-is="module-works"] .wrap-module{width:92%;max-width:948px;margin:0 auto} module-works .wrap-module p,[data-is="module-works"] .wrap-module p{color:#fff;letter-spacing:1px} module-works .wrap-module .wrap-works .box-dummy,[data-is="module-works"] .wrap-module .wrap-works .box-dummy{display:block;width:19.8%;background:#fff} module-works .wrap-module .wrap-works .box-dummy .dummy-content,[data-is="module-works"] .wrap-module .wrap-works .box-dummy .dummy-content{display:block;position:relative;width:100%;height:auto;overflow:hidden;background-repeat:no-repeat;background-size:cover;background-position:center} module-works .wrap-module .wrap-works .box-dummy .dummy-content:before,[data-is="module-works"] .wrap-module .wrap-works .box-dummy .dummy-content:before{content:"";display:block;padding-top:100%} module-works .wrap-module .wrap-works .hide,[data-is="module-works"] .wrap-module .wrap-works .hide{background:#ffffff}@media only screen and (max-width:600px){ module-works .hide,[data-is="module-works"] .hide{display:none}}', 'class="pt40 pb80"', function(opts) {
    this.h2 = {
      label: '展示作品 (順次公開)',
      color: 'color:#2A45F4; border-color:#2A45F4;',
    };
