...
riot.tag2('module-content-work', '<div class="wrap-module"> <h2>{opts.content.label}</h2> <div class="wrap-explain mt20"> <p>{opts.content.explain}</p> </div> <div class="wrap-prof mt12"> <p>{opts.content.name}</p> <p>{opts.content.belonging}</p> </div> <div class="wrap-img mt40"><img each="{item in imgs}" riot-src="{item}"></div> </div>', 'module-content-work,[data-is="module-content-work"]{display:block;background:#2B45F4} module-content-work .wrap-module,[data-is="module-content-work"] .wrap-module{width:60%;max-width:948px;margin:0 auto} module-content-work .wrap-module h2,[data-is="module-content-work"] .wrap-module h2{color:#fff} module-content-work .wrap-module .wrap-explain p,[data-is="module-content-work"] .wrap-module .wrap-explain p{color:#FFF;font-weight:lighter} module-content-work .wrap-module .wrap-prof p,[data-is="module-content-work"] .wrap-module .wrap-prof p{color:#FFF;text-align:right;font-weight:lighter}@media only screen and (max-width:600px){ module-content-work .wrap-module,[data-is="module-content-work"] .wrap-module{width:92%}}', '', function(opts) {
