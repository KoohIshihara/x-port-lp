...
riot.tag2('item-guest', '<div class="wrap-item f"> <div class="wrap-img"><img riot-src="{opts.content.src}"></div> <div class="wrap-info ml12"> <div class="wrap-name"> <p class="name">{opts.content.name}</p> </div> <p class="about">{opts.content.about}</p> </div> </div>', 'item-guest,[data-is="item-guest"]{display:block} item-guest .wrap-item .wrap-img,[data-is="item-guest"] .wrap-item .wrap-img{width:64px} item-guest .wrap-item .wrap-info p,[data-is="item-guest"] .wrap-item .wrap-info p{color:#FFF;letter-spacing:1px} item-guest .wrap-item .wrap-info .wrap-name .name,[data-is="item-guest"] .wrap-item .wrap-info .wrap-name .name{font-size:16px;font-weight:bold;line-height:1.5} item-guest .wrap-item .wrap-info .about,[data-is="item-guest"] .wrap-item .wrap-info .about{font-size:13px;font-weight:bold;opacity:.85}', 'class="s-mr0 mr40 mb20"', function(opts) {
});
...
riot.tag2('item-label-detail', '<div class="wrap-item"> <div class="wrap-p"> <p class="px3 py3">{opts.content}</p> </div> </div>', 'item-label-detail,[data-is="item-label-detail"]{display:block} item-label-detail .wrap-item .wrap-p,[data-is="item-label-detail"] .wrap-item .wrap-p{display:inline-block;position:relative} item-label-detail .wrap-item .wrap-p p,[data-is="item-label-detail"] .wrap-item .wrap-p p{display:inline;color:#FFF !important;font-size:14px;font-weight:300;letter-spacing:1px;background:linear-gradient(to right, rgba(255,255,255,0) 50%, #2a45f4 50%);background-size:200%;background-position:-100% 0}', 'class="mb12"', function(opts) {
});

riot.tag2('item-label-event', '<div class="wrap-item"> <div class="wrap-p"> <p class="px4 py1">{opts.content}</p> </div> </div>', 'item-label-event,[data-is="item-label-event"]{display:block} item-label-event .wrap-item .wrap-p,[data-is="item-label-event"] .wrap-item .wrap-p{display:inline-block;left:-4px;position:relative} item-label-event .wrap-item .wrap-p p,[data-is="item-label-event"] .wrap-item .wrap-p p{display:inline;color:#2A45F4;font-size:18px;font-weight:700;letter-spacing:2px;background:linear-gradient(to right, rgba(255,255,255,0) 50%, #fff 50%);background-size:200%;background-position:-100% 0}@media only screen and (max-width:600px){ item-label-event .wrap-item .wrap-p,[data-is="item-label-event"] .wrap-item .wrap-p{left:-2px}}', '', function(opts) {
});
...
riot.tag2('module-footer', '<div class="wrap-module py20"> <p class="pb8 mt12">主催：慶應義塾大学湘南藤沢キャンパス（SFC）</p> <p>お問い合わせ：hogehoge@sfc.keio.ac.jp</p> <p class="copy">Copyright © 2018 Hoge Fuga of Hoge. All Rights Reserved.</p> </div>', 'module-footer,[data-is="module-footer"]{display:block;background:#EFEFEF;width:100%;height:30vh} module-footer .wrap-module,[data-is="module-footer"] .wrap-module{position:relative;width:92%;height:100%;max-width:948px;margin:0 auto;font-weight:bold;font-size:12px} module-footer .wrap-module p,[data-is="module-footer"] .wrap-module p{color:#000;opacity:.6} module-footer .wrap-module .copy,[data-is="module-footer"] .wrap-module .copy{width:100%;position:absolute;bottom:5%;text-align:center}', '', function(opts) {
});
