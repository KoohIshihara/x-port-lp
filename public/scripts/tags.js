...
riot.tag2('item-cooperation', '<div class="wrap-item" riot-style="background-image: url(&quot;{opts.content.src}&quot;);"></div>', 'item-cooperation,[data-is="item-cooperation"]{display:block;width:25%;height:10vh} item-cooperation .wrap-item,[data-is="item-cooperation"] .wrap-item{position:relative;height:100%;width:100%;overflow:hidden;background-repeat:no-repeat;background-size:contain;background-position:center} item-cooperation .box-1x1:before,[data-is="item-cooperation"] .box-1x1:before{content:"";display:block;padding-top:100%}@media only screen and (max-width:600px){ item-cooperation,[data-is="item-cooperation"]{width:80%;height:8vh} item-cooperation .wrap-item,[data-is="item-cooperation"] .wrap-item{margin-bottom:32px;background-size:contain}}', 'class="my32"', function(opts) {
});

riot.tag2('item-guest', '<div class="wrap-item f"> <div class="wrap-img"><img riot-src="{opts.content.src}"></div> <div class="wrap-info ml8"> <div class="wrap-name"> <p class="name">{opts.content.name}</p> </div> <p class="about">{opts.content.about}</p> </div> </div>', 'item-guest,[data-is="item-guest"]{display:block;width:50%} item-guest .wrap-item .wrap-img,[data-is="item-guest"] .wrap-item .wrap-img{width:10vw} item-guest .wrap-item .wrap-info p,[data-is="item-guest"] .wrap-item .wrap-info p{color:#FFF;letter-spacing:1px} item-guest .wrap-item .wrap-info .wrap-name .name,[data-is="item-guest"] .wrap-item .wrap-info .wrap-name .name{font-size:16px;font-weight:bold;line-height:1.5} item-guest .wrap-item .wrap-info .about,[data-is="item-guest"] .wrap-item .wrap-info .about{font-size:13px;opacity:.85}@media only screen and (max-width:600px){ item-guest,[data-is="item-guest"]{width:auto} item-guest .wrap-item .wrap-img,[data-is="item-guest"] .wrap-item .wrap-img{width:20vw}}', 'class="s-mr0 mb20"', function(opts) {
});
...
riot.tag2('module-detail', '<div class="wrap-module py20"> <item-h2 class="mb24" content="{h2}"></item-h2> <div class="wrap-content"> <item-label-detail content="日時"></item-label-detail> <p>2018.03.24(sat) – 25(sun)</p> <p>11:00～18:00</p> </div> <div class="wrap-content"> <item-label-detail content="会場"></item-label-detail> <p><a target="_blank" href="https://goo.gl/maps/3jjwRbB8C5o">YCC ヨコハマ創造都市センター</a></p> <p>(3Fイベントスペース)</p> <p>みなとみらい線「馬車道駅」1B出口から直結</p> <p>JR・市営地下鉄「桜木町駅」より徒歩5分</p> <item-map class="my24"></item-map> </div> <div class="wrap-content"> <item-label-detail content="入場料"></item-label-detail> <p>無料</p> </div> <div class="wrap-content"> <item-label-detail content="お問い合わせ"></item-label-detail><a href="mailto:x-port@example.com">x-port@example.com</a> </div> <div class="wrap-content"> <item-label-detail content="協賛企業"></item-label-detail> <p class="mb24">この展示会は、モノづくりに励む学生たちを応援する様々な企業よりご支援頂いおります。</p> <div class="wrap-cooperations f flex-wrap flex-row flex-center mt40"> <item-cooperation each="{item in cooperations}" content="{item}"></item-cooperation> </div> </div> <div class="wrap-content"></div> </div>', 'module-detail,[data-is="module-detail"]{display:block;background:#fff} module-detail .wrap-module,[data-is="module-detail"] .wrap-module{width:92%;max-width:948px;margin:0 auto} module-detail .wrap-module .wrap-content,[data-is="module-detail"] .wrap-module .wrap-content{margin-bottom:32px} module-detail .wrap-module .wrap-content p,[data-is="module-detail"] .wrap-module .wrap-content p{color:#2A45F4;font-size:20px;letter-spacing:1px;line-height:1.8} module-detail .wrap-module .wrap-content a,[data-is="module-detail"] .wrap-module .wrap-content a{font-size:20px;color:#2A45F4;font-weight:bold;border-bottom:solid 2px;line-height:1.8} module-detail .wrap-module .wrap-content .howto,[data-is="module-detail"] .wrap-module .wrap-content .howto{font-size:16px}@media only screen and (max-width:600px){ module-detail .wrap-module .wrap-content p,[data-is="module-detail"] .wrap-module .wrap-content p{font-size:15px} module-detail .wrap-module .wrap-content a,[data-is="module-detail"] .wrap-module .wrap-content a{font-size:15px} module-detail .wrap-module .wrap-content .howto,[data-is="module-detail"] .wrap-module .wrap-content .howto{font-size:13px}}', 'class="py40"', function(opts) {
    ...
    this.cooperations = [
      ...
      {
        label: 'fabcross',
        src: './img/cooperation/fabcross.gif',
      },
